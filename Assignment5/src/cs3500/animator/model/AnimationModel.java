...
public interface AnimationModel {
  ...
  /**
   * Get the set of Shapes in the cs3500.animator.model along with their
   * corresponding IAction lists.
   *
  ...
  /**
   * Getter method to return the width of the bounding box for the canvas.
   */
  int getWidth();

  /**
   * Getter method to return the height of the bounding box for the canvas.
   */
  int getHeight();

  /**
   * Getter method to return the leftmost x value of the bounding box for the canvas.
   */
  int getMaxX();

  /**
   * Getter method to return the uppermost y value of the bounding box for the canvas.
   */
  int getMaxY();
}
