...
import cs3500.marblesolitaire.model.hw04.EuropeanMarbleSolitaireModelImpl;
...
public class MarbleSolitaireModelImplTest {
  ...
  @Test
  public void testGetGameStateEuro5() {
    MarbleSolitaireModel initData = new EuropeanMarbleSolitaireModelImpl(5);
  ...
  @Test
  public void testGetGameStateEuro3() {
    MarbleSolitaireModel initData = new EuropeanMarbleSolitaireModelImpl(3);
    assertEquals("    O O O\n" +
            "  O O O O O\n" +
            "O O O O O O O\n" +
            "O O O _ O O O\n" +
