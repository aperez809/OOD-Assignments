...
public class MarbleSolitaireModelImplTest {
  ...
  public void testGetGameStateEuro5() {
    MarbleSolitaireModel initData = new EuropeanSolitaireModelImpl(5);
  ...
  public void testGetGameStateEuro3() {
    MarbleSolitaireModel initData = new EuropeanSolitaireModelImpl(3);
    assertEquals(initData.getGameState(),
            "    O O O\n" +
            "  O O O O O\n" +
            "O O O O O O O\n" +
            "O O O O O O O\n" +
